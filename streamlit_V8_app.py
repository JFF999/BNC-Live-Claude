...
# === v8 : mission « Surveiller Les Affaires » pour Claude (bouton 🤖, PC seulement).
# L'app tourne sur Streamlit Cloud : impossible de lancer Chrome ou l'app Claude de
# bureau depuis un bouton. On ouvre donc claude.ai dans un NOUVEL onglet du navigateur
# courant, avec la mission préremplie — il ne reste qu'à l'envoyer.
PROMPT_COWORK_AFF = (
    "Surveille la page « À surveiller » de Les Affaires : "
    "https://www.lesaffaires.com/bourse/a-surveiller/ — ouvre la page, liste les "
    "recommandations d'analystes du jour (symbole, cours cible, firme d'analyse) "
    "et signale ce qui est NOUVEAU par rapport aux jours précédents."
)
URL_COWORK_AFF = "https://claude.ai/new?q=" + urllib.parse.quote(PROMPT_COWORK_AFF)
...
if col_cw is not None:
    # PC seulement : ouvre claude.ai (nouvel onglet du navigateur courant) avec la
    # mission de surveillance Les Affaires préremplie — appuyer sur Entrée pour lancer.
    col_cw.link_button("🤖", URL_COWORK_AFF,
                       help="Claude : surveiller Les Affaires (mission préremplie)")
with col_la:
